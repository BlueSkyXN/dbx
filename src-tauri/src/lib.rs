...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::external_table::external_table_list,
            commands::external_table::external_table_describe,
            commands::external_table::external_table_read_page,
            commands::external_table::external_table_apply_changes,
