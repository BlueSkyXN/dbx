...
export function isFeishuBitableTableEditable(params: {
  databaseType?: DatabaseType;
  context?: "results" | "table-data";
  connectionId?: string;
  tableMeta?: ExternalTableMeta;
  resultColumns: string[];
}): boolean {
  return (
    params.databaseType === "feishu_bitable" &&
    params.context === "table-data" &&
    !!params.connectionId &&
    !!params.tableMeta &&
    !!externalRecordIdColumn(params.tableMeta.primaryKeys, params.resultColumns)
  );
}
