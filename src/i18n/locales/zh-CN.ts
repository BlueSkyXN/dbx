export default {
  ...
  connection: {
    ...
    fileSnapshotHint: "文件数据会作为只读快照加载。文件变更后请使用“刷新文件快照”。",
    user: "用户名",
    password: "密码",
    database: "数据库",
  ...
  contextMenu: {
    ...
    editStructure: "编辑表结构",
    refreshChildren: "刷新",
    refreshExternalSnapshot: "刷新文件快照",
    refreshExternalSnapshotSuccess: "文件快照已刷新",
    refreshExternalSnapshotFailed: "刷新文件快照失败：{message}",
    pin: "置顶",
    unpin: "取消置顶",
    refreshTab: "刷新数据",
    closeTab: "关闭标签页",
