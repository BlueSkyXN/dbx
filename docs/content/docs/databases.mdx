...
- Ordinary `.xlsx` workbooks, with worksheet selection, an optional A1 data range, and formula cells kept read-only
- Feishu Sheets, authenticated with an app ID and app secret
