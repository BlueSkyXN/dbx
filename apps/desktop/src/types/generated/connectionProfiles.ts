...
export const CONNECTION_PICKER_OPTIONS = [
  ...
  { value: "csvfile", label: "CSV", category: "lightweight" },
  { value: "xlsxfile", label: "XLSX", category: "lightweight" },
  { value: "feishu_sheets", label: "Feishu Sheets", category: "lightweight" },
  { value: "feishu_bitable", label: "Feishu Bitable", category: "lightweight" },
