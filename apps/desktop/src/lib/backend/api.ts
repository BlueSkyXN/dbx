...
export const externalTableList = forward("externalTableList");
export const externalTableDescribe = forward("externalTableDescribe");
export const externalTableReadPage = forward("externalTableReadPage");
export const externalTableApplyChanges = forward("externalTableApplyChanges");
