...
const UNSUPPORTED_VISIBLE_DATABASE_TYPES = new Set<DatabaseType>(["csvfile", "xlsxfile", "feishu_sheets", "feishu_bitable", "turso", "cloudflare-d1", "dynamodb", "elasticsearch", "easysearch", "meilisearch", "qdrant", "milvus", "weaviate", "chromadb", "etcd", "zookeeper", "mq", "nacos", "consul"]);
