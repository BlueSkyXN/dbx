...
export const DATABASE_NAMESPACE_CREATION_MATRIX = {
  ...
  csvfile: { deferred: "file-backed source; create or select a file connection instead" },
  xlsxfile: { deferred: "file-backed source; create or select a workbook connection instead" },
  feishu_sheets: { deferred: "spreadsheet lifecycle is managed by Feishu" },
  feishu_bitable: { deferred: "Bitable app and table lifecycle is managed by Feishu" },
