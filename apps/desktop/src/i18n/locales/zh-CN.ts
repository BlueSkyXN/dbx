...
export default withEnglishFallback({
  ...
  connection: {
    ...
    addHost: "添加主机",
    filePath: "文件路径",
    externalCsvDelimiter: "分隔符",
    externalCsvDelimiterComma: "逗号 (,)",
    externalCsvDelimiterTab: "制表符",
    externalCsvDelimiterSemicolon: "分号 (;)",
    externalCsvDelimiterPipe: "竖线 (|)",
    externalCsvEncoding: "编码",
    externalHasHeader: "首行为表头",
    externalHasHeaderHint: "将第一行作为列名。",
    externalDataRange: "数据范围",
    externalDataRangePlaceholder: "A1:D100",
    externalXlsxDataRangeHint: "如果该范围未包含 workbook 中的其他已用单元格，将禁用追加和物理删行。",
    externalFeishuDataRangeHint: "留空时仅支持只读浏览。编辑必须填写明确范围；追加和物理删行还要求该范围包含探测到的全部已用单元格。",
  ...
  externalTable: {
    saveUnknown: "写入结果无法确认。重新加载前不能再次保存。",
    ...
    incompleteRead: "来源返回了不完整数据；在完整刷新成功前已禁用编辑。",
    desktopOnly: "外部表格连接仅在 DBX 桌面端可用。",
    discardPendingConfirm: "放弃待保存修改并重新加载外部来源吗？",
    selectTable: "选择表格",
    incomplete: "数据不完整",
    readOnly: "只读",
    page: "第 {page} 页",
  ...
  grid: {
    ...
    customSaveBlockedReloadRequired: "上次写入结果仍未确认，当前禁止再次保存。请先重新加载来源。",
