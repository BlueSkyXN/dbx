...
export default withEnglishFallback({
  ...
  connection: {
    ...
    delimiterPipe: "竖线 (|)",
    xlsxSheetName: "工作表",
    xlsxSheetNamePlaceholder: "可选，留空加载全部工作表",
    firstRowHeader: "首行为表头",
    fileSnapshotHint: "文件数据会作为只读快照加载。文件变更后请使用“刷新外部数据快照”。",
    feishuAccessToken: "Access Token",
    feishuAppId: "App ID",
    feishuAppSecret: "App Secret",
    feishuAuthHint: "可填写 Access Token，或使用 App ID 和 App Secret 自动获取 tenant access token。",
    feishuSaveCredentials: "保存 Feishu 凭据",
    feishuSaveCredentialsHint: "将 Access Token 和 App Secret 保存到受保护的本地秘密存储。",
    feishuSessionCredentialsHint: "Access Token 和 App Secret 只在本次运行期间保留在内存中。",
    feishuSpreadsheetToken: "Spreadsheet Token",
    feishuSheetId: "Sheet ID",
    feishuRange: "数据范围",
    feishuRangePlaceholder: "A1:Z1000 或 sheetId!A1:Z1000",
    feishuOptionalPlaceholder: "可选",
    feishuLimit: "读取上限",
    feishuRows: "行数",
    feishuColumns: "列数",
    ...
    feishuBitableFields: "字段",
    feishuBitableFieldsPlaceholder: "名称, 金额",
    feishuPageSize: "分页大小",
    feishuMaxRecords: "最大记录数",
    feishuSyncMode: "同步模式",
    feishuSyncSnapshot: "快照 / 手动刷新",
    feishuSyncRealtime: "查询前自动刷新（最短间隔 5 秒）",
    h2FileMode: "文件",
    h2TcpMode: "TCP",
  ...
  contextMenu: {
    ...
    refreshExternalSnapshot: "刷新外部数据快照",
    refreshExternalSnapshotSuccess: "外部数据快照已刷新",
    refreshExternalSnapshotFailed: "刷新外部数据快照失败：{message}",
    pin: "置顶",
