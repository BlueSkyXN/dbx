...
export default {
  ...
  connection: {
    ...
    addHost: "Add Host",
    filePath: "File Path",
    externalCsvDelimiter: "Delimiter",
    externalCsvDelimiterComma: "Comma (,)",
    externalCsvDelimiterTab: "Tab",
    externalCsvDelimiterSemicolon: "Semicolon (;)",
    externalCsvDelimiterPipe: "Pipe (|)",
    externalCsvEncoding: "Encoding",
    externalHasHeader: "Header row",
    externalHasHeaderHint: "Use the first row as column names.",
    externalDataRange: "Data range",
    externalDataRangePlaceholder: "A1:D100",
    externalXlsxDataRangeHint: "Append and physical row deletion are disabled when this range excludes other used workbook cells.",
    externalFeishuDataRangeHint: "Leave blank for read-only browsing. Editing requires an explicit range; structural changes also require it to contain all detected used cells.",
    externalFeishuAppId: "App ID",
    externalFeishuAppSecret: "App Secret",
    externalFeishuSpreadsheetToken: "Spreadsheet token",
    externalFeishuSheetId: "Sheet ID",
    externalFeishuBaseToken: "Base token",
    externalFeishuTableId: "Table ID",
    externalFeishuViewId: "View ID",
    h2FileMode: "File",
    h2TcpMode: "TCP",
  ...
  externalTable: {
    saveUnknown: "The write outcome is uncertain. Reload before making another save.",
    ...
    incompleteRead: "The source returned incomplete data. Editing is disabled until a complete reload succeeds.",
    desktopOnly: "External table connections are available only in the DBX desktop app.",
    discardPendingConfirm: "Discard pending changes and reload the external source?",
    ...
    nextPage: "Next page",
    reload: "Reload",
    noTables: "No external tables are available.",
  },
  queryMessages: {
    empty: "No messages",
    code: "Code: {code}",
  ...
  grid: {
    ...
    customSaveBlockedReloadRequired: "Saving is blocked because the previous write outcome is unresolved. Reload the source before saving again.",
