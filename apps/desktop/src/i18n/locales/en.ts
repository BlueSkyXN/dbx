...
export default {
  ...
  connection: {
    ...
    delimiterPipe: "Pipe (|)",
    xlsxSheetName: "Sheet",
    xlsxSheetNamePlaceholder: "Optional, loads all sheets",
    firstRowHeader: "First row contains headers",
    fileSnapshotHint: "File data is loaded as a read-only snapshot. Use Refresh External Snapshot after the file changes.",
    feishuAccessToken: "Access Token",
    feishuAppId: "App ID",
    feishuAppSecret: "App Secret",
    feishuAuthHint: "Provide an access token, or use App ID and App Secret to obtain a tenant access token automatically.",
    feishuSaveCredentials: "Save Feishu credentials",
    feishuSaveCredentialsHint: "Store the Access Token and App Secret in protected local secret storage.",
    feishuSessionCredentialsHint: "Keep the Access Token and App Secret in memory for this session only.",
    feishuSpreadsheetToken: "Spreadsheet Token",
    feishuSheetId: "Sheet ID",
    feishuRange: "Range",
    feishuRangePlaceholder: "A1:Z1000 or sheetId!A1:Z1000",
    feishuOptionalPlaceholder: "Optional",
    feishuLimit: "Limit",
    feishuRows: "Rows",
    feishuColumns: "Columns",
    feishuBitableAppToken: "App Token",
    feishuBitableTableId: "Table ID",
    feishuBitableViewId: "View ID",
    feishuBitableFields: "Fields",
    feishuBitableFieldsPlaceholder: "Name, Amount",
    feishuPageSize: "Page size",
    feishuMaxRecords: "Max records",
    feishuSyncMode: "Sync",
    feishuSyncSnapshot: "Snapshot / manual refresh",
    feishuSyncRealtime: "Auto-refresh before queries (5-second minimum interval)",
    h2FileMode: "File",
    h2TcpMode: "TCP",
  ...
  contextMenu: {
    ...
    refreshExternalSnapshot: "Refresh External Snapshot",
    refreshExternalSnapshotSuccess: "External snapshot refreshed",
    refreshExternalSnapshotFailed: "Failed to refresh external snapshot: {message}",
    pin: "Pin",
