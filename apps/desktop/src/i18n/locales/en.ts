export default {
  ...
  connection: {
    ...
    fileSnapshotHint: "File data is loaded as a read-only snapshot. Use Refresh File Snapshot after the file changes.",
    h2FileMode: "File",
    h2TcpMode: "TCP",
  ...
  contextMenu: {
    ...
    refreshExternalSnapshot: "Refresh File Snapshot",
    refreshExternalSnapshotSuccess: "File snapshot refreshed",
    refreshExternalSnapshotFailed: "Failed to refresh file snapshot: {message}",
    pin: "Pin",
    unpin: "Unpin",
