...
pub fn profile_for(db_type: DatabaseType) -> DdlDialectProfile {
    ...
    match db_type {
        ...
        DuckDb | CsvFile | XlsxFile | FeishuSheets | FeishuBitable | Questdb | SapHana | Teradata | Snowflake
        | Trino | PrestoSql | Hive | Kyuubi | Impala | Spark | Db2 | Informix | Bigquery | Spanner | Kylin | Ignite
        | Ignite3 | Oscar | Tdengine | Iotdb | Databricks | Jdbc => conservative_ansi(db_type),
